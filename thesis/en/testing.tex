...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.8\textwidth]{docs/screenshots/testing/e2e with cypress.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.8\textwidth]{docs/screenshots/testing/performance with locust.png}}
